export function compareFn(a: unknown, b: unknown): number {
	...
	if (typeof a === "string" || typeof b === "string") {
		if (a && b) {
			const v1: string = (a as string).toLowerCase();
			const v2: string = (b as string).toLowerCase();
...
export function generateArrayNumber(start: number, end: number): Array<number> {
